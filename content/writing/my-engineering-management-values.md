...
In my career, I worked in very different industries, covering all kind of
...
Looking back, I find that this is a tad puzzling.

Some sort of strange chicken and egg problem I can't untangle: Do I _always_
find myself in leading positions because I'm good at it or did I become good at
it because I _always_ had to lead people?
...
Because I believe trust is what makes a good leader, it's somewhat obvious that
it is the common denominator of all my values.

Also worth noticing that I use  "leader" instead of "engineering manager". It's
...
never held the title of engineering manager. More specifically, I was never
...
From my conversations with engineering managers friends, these conversations are
somewhat rare and just tangential to the job so I believe I'd have hard times in
the role.

Be aware I'm not saying these conversations are the only way to gain developers'
trust. I'm providing context about what my experience has been so that, once I
discuss my values, it's clear how I apply them to the job.

Before I move on to the values themselves, let me also address why I think the
fact I've been leading teams all my career is also relevant to this article.
...
- I would rather lead a team so I could self-organise my own time than "just" be
  ...
  I had apart from one (hey [Fabian](https://twitter.com/fabiansiegel) 👋) has
...
- [Written communication](#written-communication)
  ...
  - [Developers' book](#developers-book)
...
I provide discussions topics only if asked to. That happens more often with
...
Succeeding at creating a safe space for people to tell me what bothers them and
what their aspirations are creates great expectations. People trusted me so now
...
That is the main reason why I think you can hardly can have more than 5 or 6
direct reports _and_ do a good job at the same time. It is too much work and too
much information.

One on ones make sense only as recurring meetings, so their frequency is
...
meet. My only requirement is an upper bound: not less than once per month.
...
Having the meeting outside the standard setup helps you send reinforce the
message "this meeting has a special meaning because it is only about you".

The meetings will be more formal with some people and "exactly like going for a
coffee" for other people. Both are fine.

In 2015, I wrote some [notes about one to ones]({{< ref
"/writing/some-notes-about-one-on-ones" >}} "my some notes about one on ones")
if you're looking for more details, the article has been revised in 2022.
...
time, I quickly realised this communication style wouldn't scale.
...
while adding reminding the team to discuss anything related to it in the
relevant place.
...
Discussions in the written form tend to be more thoughtful than in-person ones
because people have time to think things through.

Now I also require people in my teams to approach large features this way. My
...
I write down the meeting invitation in this form:

- what's the point of the meeting
- what are the topics we want to cover (order often relevant)
- what's the expected outcome

This simplifies my job a little as I can quickly context-switch into "meeting
mode" as soon as I read the agenda therefore this helps me moderating it.
...
personally like it very much, I found that meeting culture is too company
specific for such a strict rule to always work.
...
make use of written communication by creating a "developer's book".

That is document providing at least the following information:
...
some starting point in the developers' book.

I store the developers' book wherever the team stores code because it allows me
to implement a process I find beautiful in its simplicity: I ask my teams to
discuss changes to processes via pull-requests to the developers' book.

The developers' book repository then becomes the point of reference for every
...
- the rest of pull-requests (meaning code) stay free from tangential
  ...
  the developers' book as that's "how we work").
- Your team will have a history of how operational decisions were made.
- The developers' book is always in sync. Can you believe I had teams with
  up-to-date docs?

Of course, the list of topics I provided is only an example. Different companies
have different needs so the developers' book should reflect that.
...
I call this communication channel "internal blogging" for lack of a better term.
What I mean is that I always have a place where I can share long pieces of
writing.

I want to be able to refer back to specific content over time. I found that
...
For example, I wrote internal blog posts about "the benefits of moving to a
mono-repository", "why we're going to use trunk based development", or "the next
generation of our Kafka infrastructure".

I share such blog posts much before the actual transition happens so that I have
time to collect feedback and minimise the situations in which change occur and
people didn't know about it.

As the teams scale, sharing knowledge becomes more and more important to avoid
that different teams solve the same problem multiple times. An internal blog is
...
- Learning to be a better writer helps becoming a better developer.
- People can proudly share their achievements and simultaneously help other team
  members learning something new.
...
only way to ensure usage spreads among team members.

Bonus side-effect: internal blogging makes public blogging much easier.

The delta between "something we wrote for ourself" and "something we want to
...
doing what I think it is right.

Because this applies to everything we do at work every day, I often felt
...
The idea is that I clarify, with daily examples, what are the things I really
care about. Let me provide some real world examples from my teams:

- I call out people using non-inclusive language
- I leave at 6pm every day unless the system is on fire
- I don't give up on a disruptive production issue unless it's solved
- I don't have chat applications systems on my phone
- I don't work outside of working hours
- You can't really reach me when I'm off

These are just examples, the point is that I learned you can't tell people to do
"the right thing" and expect them to follow you. You have to be that person
yourself.
...
This sounds great in theory but, to be fair, it is hard to practice because:
...
This also helps me making sure I can actually hire slowly. While I'm
interviewing people, I'm not trying to solve a now problem so I can take my time
with it.

Hiring slow is how I minimize false positives. If I hire the wrong people, the
...
I organize in the following checkpoints:
...
a while and they realize they are not happy anymore.

Companies are living entities and they often evolve too fast. There is nothing
wrong about this.

In such cases, I pay extra attention about how I let people go. It is easy for
both parties to show lack of care and leave behind a bad feeling.

The solution is talking as much as possible about it. They helped you achieve
your goals, now it is your turn to show them you appreciate what they have done.

The best possible outcome is I help them finding the new job and ensure a smooth
transition.
...
In reality, these privileges create the worst dynamic: it frustrates newer team
...
tend to emulate your mistakes too.

It has always been difficult for me: seeing people considering my own mistakes
as acceptable behaviour.

When I figure out I made a mistake, I just go with radical honesty about it.
